...
sheet_name = "InvestimentoAnalitico"
...
try:
    with engine.begin() as conn:
        ...
        df.to_sql("TB_STAGE_INVESTIMENTO_ANALITICO", conn, schema="STG", if_exists="append", index=False)
        print(f"🚀 {len(df)} registros carregados em STG.TB_STAGE_INVESTIMENTO_ANALITICO")
